...
describe('mrud-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      ...
      html: `<mrud-ambulance-wl-editor entry-id="test-entry"
  ...
  it('first text field is patient name', async () => {
    ...
    const page = await newSpecPage({
       components: [MrudAmbulanceWlEditor],
       html: `<mrud-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></mrud-ambulance-wl-editor>`,
    });
