...
@Component({
  tag: 'mrud-ambulance-wl-editor',
  styleUrl: 'mrud-ambulance-wl-editor.css',
  shadow: true,
})
export class MrudAmbulanceWlEditor {
  @Prop() entryId: string;
  ...
  return (
    <Host>
      <form ref={el => this.formElement = el}>
        ...
        <md-filled-text-field label="Registračné číslo pacienta" r
